...
<h1 align="center">ToGO for Claude Code</h1>

<p align="center">
  A Claude Code <b>plugin</b> — start and drive <a href="https://to-go.dev">togo</a> apps with AI.<br/>
  One binary: Go API + React UI. Generators, specialist agents, conventions, and the togo MCP — auto-wired.
</p>
